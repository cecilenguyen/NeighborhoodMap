...
// open marker details and animate
function openMarker() {
...
function AppViewModel() {
	...
	this.filter = ko.computed(function() {
	    ...
	    for (i = 0; i < markers.length; i++) {
	    	// check if searched term matches any of the location titles & change visiblity accordingly
	        if (markers[i].title.toUpperCase().indexOf(this.searched().toUpperCase()) > -1) {
...
// call back function to start application
function startApp() {
